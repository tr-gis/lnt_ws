...
if("TRUE" STREQUAL "TRUE")
  set(manipulator_control_SOURCE_PREFIX /home/raj/lnt_ws/src/manipulator_control)
  set(manipulator_control_DEVEL_PREFIX /home/raj/lnt_ws/devel)
  ...
  set(manipulator_control_INSTALL_PREFIX /home/raj/lnt_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'manipulator_control' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'raj <raj@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'manipulator_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/raj/lnt_ws/src/manipulator_control/${idir}'.  Ask the maintainer 'raj <raj@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${manipulator_control_dep}_FOUND)
      find_package(${manipulator_control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${manipulator_control_dep} REQUIRED ${depend_list})
  endif()
